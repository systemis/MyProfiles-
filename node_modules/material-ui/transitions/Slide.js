...
var Slide = function (_Component) {
  ...
  function Slide() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Slide.__proto__ || Object.getPrototypeOf(Slide)).call.apply(_ref, [this].concat(args))), _this), _this.handleEnter = function (element) {
      ...
      element.style.transition = transitions.create('transform', _this.props.enterTransitionDuration + 'ms', '0ms', _transitions.easing.easeOut);
      ...
      element.style.transition = transitions.create('transform', _this.props.leaveTransitionDuration + 'ms', '0ms', _transitions.easing.sharp);
      element.style.transform = getTranslateValue(_this.props, element);
